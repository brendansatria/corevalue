...
round1Layout[3][0] = { type: 'customer', asset: '/assets/game/pelanggan_baru_5RP_tile.png' };
round1Layout[0][1] = { type: 'customer', asset: '/assets/game/pelanggan_tetap_10RP_tile.png' };
round1Layout[0][3] = { type: 'customer', asset: '/assets/game/pelanggan_tetap_15RP_tile.png' };
...
round2Layout[1][0] = { type: 'customer', asset: '/assets/game/pelanggan_baru_5RP_tile.png' };
round2Layout[2][0] = { type: 'customer', asset: '/assets/game/pelanggan_baru_5RP_tile.png' };
round2Layout[0][2] = { type: 'customer', asset: '/assets/game/pelanggan_tetap_10RP_tile.png' };
round2Layout[3][4] = { type: 'customer', asset: '/assets/game/pelanggan_tetap_15RP_tile.png' };
...
round3Layout[2][0] = { type: 'customer', asset: '/assets/game/pelanggan_baru_5RP_tile.png' };
round3Layout[3][4] = { type: 'customer', asset: '/assets/game/pelanggan_baru_5RP_tile.png' };
round3Layout[4][0] = { type: 'customer', asset: '/assets/game/pelanggan_baru_5RP_tile.png' };
round3Layout[0][1] = { type: 'customer', asset: '/assets/game/pelanggan_tetap_10RP_tile.png' };
round3Layout[0][3] = { type: 'customer', asset: '/assets/game/pelanggan_tetap_15RP_tile.png' };
...
round4Layout[2][0] = { type: 'customer', asset: '/assets/game/pelanggan_baru_5RP_tile.png' };
round4Layout[3][0] = { type: 'customer', asset: '/assets/game/pelanggan_baru_5RP_tile.png' };
round4Layout[1][4] = { type: 'customer', asset: '/assets/game/pelanggan_tetap_10RP_tile.png' };
round4Layout[4][4] = { type: 'customer', asset: '/assets/game/pelanggan_tetap_10RP_tile.png' };
round4Layout[0][1] = { type: 'customer', asset: '/assets/game/pelanggan_tetap_15RP_tile.png' };
round4Layout[0][3] = { type: 'customer', asset: '/assets/game/pelanggan_tetap_15RP_tile.png' };
...
round2Layout[2][2] = { type: 'path', asset: '/assets/game/L_path_tile.png', rotatable: true };
